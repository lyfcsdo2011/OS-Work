...
--*/
{
	...
	/********设置时间片***************/
	PspCurrentThread->LifeTimeTicks = TICKS_OF_TIME_SLICE * 5;	// 设置生命周期为9个时间片
	PspCurrentThread->InitTicks = TICKS_OF_TIME_SLICE;			// 设置初始化时间片大小
	PspCurrentThread->UsedTicks = 0;							// 设置已使用的时间片大小
	/*********************************/
