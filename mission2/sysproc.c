...
--*/
{
	...
	fprintf(StdHandle, "pt:show process and thread information.\n");
	fprintf(StdHandle, "mm:show Secondary page table mapping information.\n");
	fprintf(StdHandle, "ds:access the specified track on the floppy disk.\n");
	fprintf(StdHandle, "rr:Test time slice rotation scheduling.\n");
	fprintf(StdHandle, "loop:Thread dead loop function.\n");
	fprintf(StdHandle, "suspend threadid:Suspend thread specified by ID.\n");
	fprintf(StdHandle, "resume threadid:Resume thread specified by ID.\n");
	fprintf(StdHandle, "vm processid:Outputs information about the virtual address descriptor of the process specified by the process ID.\n");
	...
	fprintf(StdHandle, "dir:Output the file information in the root directory of the floppy disk.\n");
