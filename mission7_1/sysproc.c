...
*/
{
	...
	//
	PVOID BaseAddress = (PVOID*)0xA0000000;	//原始为0，修改为被占用的0xA0000000和0xA0017004观察虚拟页分配情况
	SIZE_T RegionSize = 2 * PAGE_SIZE; // 原始为1，修改为PAGE_SIZE + 1或PAGE_SIZE * 2 + 1观察虚拟内存大小对页分配大小和地址的影响	
